...
**«Ориентир»** — это интерактивная веб-платформа (Основные функции находятся в разработке) исследующая архитектуру защиты сознания от манипулятивного воздействия искусственного интеллекта. Проект сочетает философский нарратив (через тексты доктора Чехова) с техническими инструментами для анализа, верификации и защиты от скрытых паттернов влияния.
